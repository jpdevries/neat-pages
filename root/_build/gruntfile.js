		...
		concat: {
			...
			foundation: {
				src: [ /* comment stuff out you don't need */
					...
					'<%= dirs.theme %><%= dirs.assets %><%= dirs.js %>foundation/foundation.accordion.js',
					'<%= dirs.theme %><%= dirs.assets %><%= dirs.js %>foundation/foundation.alert.js',
					...
					'<%= dirs.theme %><%= dirs.assets %><%= dirs.js %>foundation/foundation.offcanvas.js',
					...
					'<%= dirs.theme %><%= dirs.assets %><%= dirs.js %>foundation/foundation.tab.js',
					'<%= dirs.theme %><%= dirs.assets %><%= dirs.js %>foundation/foundation.tooltip.js',
